...
// replace uri with copy/paste from mongodb driver connectionstring, keep <username>:<password>
const uri:string = `mongodb+srv://<username>:<password>@cluster0.b4g2p.mongodb.net/?retryWrites=true&w=majority`;
